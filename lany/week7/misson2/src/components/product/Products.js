...
export default function Products({ isMarket }) {
  ...
  window.addEventListener("scroll", function () {
    this.window.scrollY > 600 ? setPosition(true) : setPosition(false);
  });
    ...
    <>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: "90px" }}>
        ...
        <div style={{ display: "flex", marginLeft: "50px" }}>
          ...
          />
          <div style={{ position: position ? "fixed" : "absolute", top: position ? "90px" : "", right: "20px", display: "flex", flexDirection: "column" }}>
            <img
              className="sideBar"
