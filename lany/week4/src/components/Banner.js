    ...
    <div style={{ display: "flex", justifyContent: "center" }}>
      ...
      <div className="banner">
        ...
        <img
          ...
          className="arrowR"
        /> */}
        <img src={banner[0]} alt="none" style={{ marginTop: "10px" }} className="inner" />
        <img src={banner[1]} alt="none" style={{ marginTop: "10px" }} className="inner" />
        <img src={banner[2]} alt="none" style={{ marginTop: "10px" }} className="inner" />
        <img src={banner[2]} alt="none" style={{ marginTop: "10px" }} className="inner" />
      </div>
    </div>
  );
