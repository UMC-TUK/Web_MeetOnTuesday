  ...
  return (
    ...
    <div className="App">
      <div class="button-group">
        ...
        <button class="button button-customer-center">
          <span>고객센터 ▼</span>
        </button>
      </div>
      <div className="_2nddiv">
        ...
        <button className="marketkurly_btn">마켓컬리</button><button className="beautykurly_btn">뷰티컬리</button>
        <div className="search3">
          <input className="search2" type="text" placeholder="검색어를 입력해주세요" />
          <button className="searchtrans">
            <img className="search1"></img>
          </button>
        </div>
    ...
    <div className="_3rddiv">
      ...
      <span class="pupple">샛별・택배</span>배송안내</div>
      </div>
      </div>
    </div>
    ...
    <div className="marketimg">
      <img src="https://product-image.kurly.com/cdn-cgi/image/quality=85/banner/main/pc/img/8c9af4e2-03ca-45ec-9a2a-926b969018ea.jpg"></img>
    </div>
